namespace x360ce.App.Controls
{
	partial class PadControl
	{
		...
		void InitializeComponent()
		{
			...
			this.CombinedIndexComboBox = new System.Windows.Forms.ComboBox();
			this.CombinedIndexLabel = new System.Windows.Forms.Label();
			this.CombinedCheckBox = new System.Windows.Forms.CheckBox();
			...
			this.RemapAllButton = new System.Windows.Forms.Button();
			...
			this.LeftThumbDownComboBox = new System.Windows.Forms.ComboBox();
			...
			this.RightThumbDownComboBox = new System.Windows.Forms.ComboBox();
			this.ButtonYComboBox = new System.Windows.Forms.ComboBox();
			this.RightThumbRightComboBox = new System.Windows.Forms.ComboBox();
			this.RightShoulderLabel = new System.Windows.Forms.Label();
			this.RightThumbLeftComboBox = new System.Windows.Forms.ComboBox();
			...
			this.RightMotorStrengthTextBox = new System.Windows.Forms.TextBox();
			...
			this.AdvancedTabPage.Size = new System.Drawing.Size(752, 438);
			...
			this.AdvancedOptionsPanel.Size = new System.Drawing.Size(746, 432);
			this.AdvancedOptionsPanel.TabIndex = 15;
			// 
			// CombineGroupBox
			// 
			this.CombineGroupBox.Controls.Add(this.CombinedIndexComboBox);
			this.CombineGroupBox.Controls.Add(this.CombinedIndexLabel);
			this.CombineGroupBox.Controls.Add(this.CombinedCheckBox);
			this.CombineGroupBox.Location = new System.Drawing.Point(3, 133);
			...
			this.CombineGroupBox.Text = "Combining";
			// 
			...
			this.CombinedIndexComboBox.Location = new System.Drawing.Point(106, 46);
			this.CombinedIndexComboBox.Name = "CombinedIndexComboBox";
			this.CombinedIndexComboBox.Size = new System.Drawing.Size(116, 21);
			this.CombinedIndexComboBox.TabIndex = 7;
			// 
			// CombinedIndexLabel
			// 
			...
			this.DeviceGroupBox.Size = new System.Drawing.Size(228, 125);
			...
			this.PassThroughIndexComboBox.Location = new System.Drawing.Point(106, 71);
			this.PassThroughIndexComboBox.Name = "PassThroughIndexComboBox";
			this.PassThroughIndexComboBox.Size = new System.Drawing.Size(117, 21);
			this.PassThroughIndexComboBox.TabIndex = 5;
			// 
			// PassThroughIndexLabel
			// 
			...
			this.DeviceSubTypeComboBox.Location = new System.Drawing.Point(105, 98);
			...
			this.GeneralTabPage.Size = new System.Drawing.Size(752, 438);
			...
			this.tableLayoutPanel1.Size = new System.Drawing.Size(746, 432);
			...
			// RemapAllButton
			// 
			this.RemapAllButton.Enabled = false;
			this.RemapAllButton.Image = global::x360ce.App.Properties.Resources.bullet_ball_glass_red_16x16;
			this.RemapAllButton.Location = new System.Drawing.Point(3, 2);
			this.RemapAllButton.Name = "RemapAllButton";
			this.RemapAllButton.Size = new System.Drawing.Size(100, 23);
			this.RemapAllButton.TabIndex = 72;
			this.RemapAllButton.Text = "Remap All";
			this.RemapAllButton.TextImageRelation = System.Windows.Forms.TextImageRelation.ImageBeforeText;
			this.RemapAllButton.UseVisualStyleBackColor = true;
			this.RemapAllButton.Click += new System.EventHandler(this.RemapAllButton_Click);
			// 
			// MapNameComboBox
			// 
			...
			this.MapNameComboBox.Location = new System.Drawing.Point(109, 3);
			this.MapNameComboBox.Name = "MapNameComboBox";
			this.MapNameComboBox.Size = new System.Drawing.Size(150, 21);
			...
			this.GeneralLeftPanel.Controls.Add(this.LeftThumbButtonComboBox);
			this.GeneralLeftPanel.Controls.Add(this.LeftTriggerLabel);
			this.GeneralLeftPanel.Controls.Add(this.LeftLabel);
			this.GeneralLeftPanel.Controls.Add(this.LeftThumbDownComboBox);
			this.GeneralLeftPanel.Controls.Add(this.LeftShoulderLabel);
			...
			this.GeneralLeftPanel.Controls.Add(this.ButtonBackComboBox);
			...
			this.GeneralLeftPanel.Controls.Add(this.LeftThumbAxisXLabel);
			...
			// 
			// LeftShoulderComboBox
			// 
			this.LeftShoulderComboBox.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
			this.LeftShoulderComboBox.FlatStyle = System.Windows.Forms.FlatStyle.Flat;
			...
			// ButtonBackComboBox
			// 
			this.ButtonBackComboBox.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
			this.ButtonBackComboBox.FlatStyle = System.Windows.Forms.FlatStyle.Flat;
			...
			// ButtonStartComboBox
			// 
			this.ButtonStartComboBox.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
			this.ButtonStartComboBox.FlatStyle = System.Windows.Forms.FlatStyle.Flat;
			...
			this.LeftThumbTextBox.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
			// 
			// LeftThumbAxisXComboBox
			// 
			...
			this.GeneralRightPanel.Controls.Add(this.RightThumbButtonComboBox);
			this.GeneralRightPanel.Controls.Add(this.RightThumbAxisYComboBox);
			this.GeneralRightPanel.Controls.Add(this.RightThumbButtonLabel);
			this.GeneralRightPanel.Controls.Add(this.RightLabel);
			this.GeneralRightPanel.Controls.Add(this.ButtonYLabel);
			this.GeneralRightPanel.Controls.Add(this.RightThumbAxisYLabel);
			this.GeneralRightPanel.Controls.Add(this.RightShoulderComboBox);
			this.GeneralRightPanel.Controls.Add(this.ButtonBLabel);
			this.GeneralRightPanel.Controls.Add(this.RightThumbAxisXComboBox);
			this.GeneralRightPanel.Controls.Add(this.RightThumbDownComboBox);
			this.GeneralRightPanel.Controls.Add(this.ButtonYComboBox);
			this.GeneralRightPanel.Controls.Add(this.RightThumbRightComboBox);
			this.GeneralRightPanel.Controls.Add(this.RightShoulderLabel);
			this.GeneralRightPanel.Controls.Add(this.RightThumbLeftComboBox);
			this.GeneralRightPanel.Controls.Add(this.ButtonXLabel);
			...
			this.GeneralRightPanel.Location = new System.Drawing.Point(553, 3);
			...
			this.RightTriggerTextBox.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
			// 
			...
			this.PadTabControl.Size = new System.Drawing.Size(760, 464);
			...
			this.ButtonsTabPage.Size = new System.Drawing.Size(752, 438);
			this.ButtonsTabPage.TabIndex = 3;
			this.ButtonsTabPage.Text = "Buttons";
			// 
			// AxisToButtonPanel
			// 
			this.AxisToButtonPanel.AutoSizeMode = System.Windows.Forms.AutoSizeMode.GrowAndShrink;
			this.AxisToButtonPanel.Controls.Add(this.AxisToButtonGroupBox);
			...
			this.AxisToButtonPanel.Size = new System.Drawing.Size(746, 486);
			...
			this.AxisToButtonGroupBox.Controls.Add(this.AxisToButtonYDeadZonePanel);
			this.AxisToButtonGroupBox.Controls.Add(this.AxisToDPadLeftDeadZonePanel);
			this.AxisToButtonGroupBox.Controls.Add(this.AxisToLeftThumbButtonDeadZonePanel);
			this.AxisToButtonGroupBox.Controls.Add(this.AxisToButtonXDeadZonePanel);
			this.AxisToButtonGroupBox.Controls.Add(this.AxisToDPadDownDeadZonePanel);
			this.AxisToButtonGroupBox.Controls.Add(this.AxisToRightShoulderDeadZonePanel);
			this.AxisToButtonGroupBox.Controls.Add(this.AxisToButtonStartDeadZonePanel);
			this.AxisToButtonGroupBox.Controls.Add(this.AxisToDPadUpDeadZonePanel);
			this.AxisToButtonGroupBox.Controls.Add(this.AxisToLeftShoulderDeadZonePanel);
			this.AxisToButtonGroupBox.Controls.Add(this.AxisToButtonBackDeadZonePanel);
			...
			this.AxisToButtonGroupBox.Size = new System.Drawing.Size(740, 430);
			...
			// ForceFeedbackPanel
			// 
			this.ForceFeedbackPanel.Controls.Add(this.InforTextBox);
			this.ForceFeedbackPanel.Controls.Add(this.ForceFeedbackGroupBox);
			this.ForceFeedbackPanel.Controls.Add(this.LeftMotorGroupBox);
			this.ForceFeedbackPanel.Controls.Add(this.groupBox1);
			this.ForceFeedbackPanel.Dock = System.Windows.Forms.DockStyle.Fill;
			...
			this.ForceTypeComboBox.Location = new System.Drawing.Point(148, 40);
			...
			this.ForceEnableCheckBox.Size = new System.Drawing.Size(59, 17);
			this.ForceEnableCheckBox.TabIndex = 1;
			this.ForceEnableCheckBox.Text = "Enable";
			this.ForceEnableCheckBox.UseVisualStyleBackColor = true;
			// 
			// ForceOverallTextBox
			// 
			this.ForceOverallTextBox.Location = new System.Drawing.Point(588, 40);
			...
			this.ForceOverallTextBox.TabIndex = 0;
			this.ForceOverallTextBox.TabStop = false;
			this.ForceOverallTextBox.Text = "100 % ";
			this.ForceOverallTextBox.TextAlign = System.Windows.Forms.HorizontalAlignment.Right;
			// 
			...
			this.OveralEffectsStengthLabel.Location = new System.Drawing.Point(352, 20);
			...
			this.ForceOverallTrackBar.Location = new System.Drawing.Point(355, 40);
			...
			this.ForceOverallTrackBar.TabIndex = 4;
			...
			// LeftMotorGroupBox
			// 
			this.LeftMotorGroupBox.Controls.Add(this.LeftMotorDirectionLabel);
			this.LeftMotorGroupBox.Controls.Add(this.LeftMotorStrengthTrackBar);
			this.LeftMotorGroupBox.Controls.Add(this.LeftMotorDirectionComboBox);
			this.LeftMotorGroupBox.Controls.Add(this.LeftMotorStrengthLabel);
			this.LeftMotorGroupBox.Controls.Add(this.LeftMotorStrengthTextBox);
			this.LeftMotorGroupBox.Controls.Add(this.LeftMotorTestTextBox);
			this.LeftMotorGroupBox.Controls.Add(this.LeftMotorTestTrackBar);
			this.LeftMotorGroupBox.Controls.Add(this.LeftMotorPeriodTextBox);
			...
			this.LeftMotorGroupBox.TabStop = false;
			this.LeftMotorGroupBox.Text = "Left Motor (Big, Strong, Low-Frequency)";
			// 
			...
			this.LeftMotorStrengthTrackBar.Location = new System.Drawing.Point(9, 70);
			...
			this.LeftMotorStrengthTrackBar.TabIndex = 4;
			this.LeftMotorStrengthTrackBar.TickFrequency = 2;
			this.LeftMotorStrengthTrackBar.Value = 100;
			this.LeftMotorStrengthTrackBar.ValueChanged += new System.EventHandler(this.LeftMotorStrengthTrackBar_ValueChanged);
			// 
			...
			this.LeftMotorDirectionComboBox.Location = new System.Drawing.Point(164, 19);
			...
			// 
			this.LeftMotorStrengthTextBox.Location = new System.Drawing.Point(242, 70);
			...
			this.LeftMotorStrengthTextBox.TabIndex = 0;
			this.LeftMotorStrengthTextBox.TabStop = false;
			this.LeftMotorStrengthTextBox.Text = "100 % ";
			this.LeftMotorStrengthTextBox.TextAlign = System.Windows.Forms.HorizontalAlignment.Right;
			// 
			// LeftMotorTestTextBox
			// 
			this.LeftMotorTestTextBox.Location = new System.Drawing.Point(239, 168);
			...
			this.LeftMotorTestTextBox.TabIndex = 0;
			this.LeftMotorTestTextBox.TabStop = false;
			this.LeftMotorTestTextBox.Text = "0 % ";
			this.LeftMotorTestTextBox.TextAlign = System.Windows.Forms.HorizontalAlignment.Right;
			// 
			// LeftMotorTestTrackBar
			// 
			this.LeftMotorTestTrackBar.AutoSize = false;
			this.LeftMotorTestTrackBar.Location = new System.Drawing.Point(6, 168);
			...
			this.LeftMotorTestTrackBar.TabIndex = 6;
			...
			// 
			this.LeftMotorPeriodTextBox.Location = new System.Drawing.Point(239, 117);
			...
			this.LeftMotorPeriodTextBox.TabIndex = 0;
			this.LeftMotorPeriodTextBox.TabStop = false;
			...
			this.LeftMotorPeriodTrackBar.Location = new System.Drawing.Point(6, 117);
			...
			this.LeftMotorPeriodTrackBar.TabIndex = 5;
			...
			// groupBox1
			// 
			this.groupBox1.Controls.Add(this.RightMotorDirectionLabel);
			this.groupBox1.Controls.Add(this.RightMotorStrengthTrackBar);
			this.groupBox1.Controls.Add(this.RightMotorDirectionComboBox);
			this.groupBox1.Controls.Add(this.RightMotorStrengthLabel);
			this.groupBox1.Controls.Add(this.RightMotorStrengthTextBox);
			this.groupBox1.Controls.Add(this.TestRightMotorLabel);
			this.groupBox1.Controls.Add(this.RightMotorPeriodTrackBar);
			this.groupBox1.Controls.Add(this.RightMotorPeriodLabel);
			...
			this.groupBox1.Text = "Right Motor (Small, Gentle, High-Frequency)";
			// 
			...
			this.RightMotorStrengthTrackBar.Location = new System.Drawing.Point(12, 70);
			...
			this.RightMotorStrengthTrackBar.TabIndex = 4;
			this.RightMotorStrengthTrackBar.TickFrequency = 2;
			this.RightMotorStrengthTrackBar.Value = 100;
			this.RightMotorStrengthTrackBar.ValueChanged += new System.EventHandler(this.RightMotorStrengthTrackBar_ValueChanged);
			// 
			...
			this.RightMotorDirectionComboBox.Location = new System.Drawing.Point(167, 19);
			...
			// 
			this.RightMotorStrengthTextBox.Location = new System.Drawing.Point(245, 70);
			...
			this.RightMotorStrengthTextBox.TabIndex = 0;
			this.RightMotorStrengthTextBox.TabStop = false;
			this.RightMotorStrengthTextBox.Text = "100 % ";
			this.RightMotorStrengthTextBox.TextAlign = System.Windows.Forms.HorizontalAlignment.Right;
			// 
			// TestRightMotorLabel
			// 
			...
			this.RightMotorPeriodTrackBar.Location = new System.Drawing.Point(12, 117);
			...
			this.RightMotorPeriodTrackBar.TabIndex = 7;
			...
			this.RightMotorTestTrackBar.Location = new System.Drawing.Point(12, 168);
			...
			this.RightMotorTestTrackBar.TabIndex = 8;
			...
			// 
			this.RightMotorTestTextBox.Location = new System.Drawing.Point(245, 168);
			...
			this.RightMotorTestTextBox.TabIndex = 0;
			this.RightMotorTestTextBox.TabStop = false;
			...
			// 
			this.RightMotorPeriodTextBox.Location = new System.Drawing.Point(245, 117);
			...
			this.RightMotorPeriodTextBox.TabIndex = 0;
			this.RightMotorPeriodTextBox.TabStop = false;
			...
			this.RemoveMapButton.Size = new System.Drawing.Size(74, 24);
			...
			this.AddMapButton.Size = new System.Drawing.Size(62, 24);
			...
			this.AutoMapButton.Size = new System.Drawing.Size(84, 24);
			...
			this.EnableButton.Size = new System.Drawing.Size(66, 24);
			...
			this.CombineGroupBox.PerformLayout();
