...
python .ai/skills/pr-review/scripts/s05_export_diff_artifacts.py --detect-renames
...
- **Windows**: The `Setup_Util_TrustedRootCertificates_Save.ps1` script is kept for corporate proxy/certificate environments. API scripts (s02, s07, s08) will automatically invoke it when running on Windows if present.
